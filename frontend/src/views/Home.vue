  ...
  <div class="home">
    ...
    <div class="header">
      <div class="header-content">
        <h1 class="title">
          <span class="title-text">开发百宝箱</span>
          <span class="title-sub">常用开发工具一站式集合</span>
        </h1>
    ...
    <!-- 底部信息 -->
    <div class="footer">
      <a href="https://github.com/hixingchen/craft" target="_blank" rel="noopener noreferrer" class="github-link">
